...
class VCF2aHMM :
    ...
    def get_args(self):
        ...
        parser.add_argument('--distM', type=float, default=0.000001, help='minimum distance between sites in bp')
        ...
        parser.add_argument('--minDP', type=float, default=0.5, help='minimum mean depth for admixed population (if no -geno flag)')
